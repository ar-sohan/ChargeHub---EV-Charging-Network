...
// ─── In-Memory Storage ───────────────────────────────────────────────────────
let chargingMaintenanceRecords: any[] = [];
let hardwareMaintenanceRecords: any[] = [];
let systemMonitoringLogs: any[] = [];
let safetyCheckRecords: any[] = [];
let faultReports: any[] = [];
let idCounter = 1;
...
export class TechnicianService {
  ...
  logChargingMaintenance(dto: CreateChargingMaintenanceDto) {
    ...
    return { message: 'Charging maintenance logged successfully', data: record };
  }
  ...
  getAllChargingMaintenance(stationId?: string) {
    ...
    return { total: chargingMaintenanceRecords.length, data: chargingMaintenanceRecords };
  }
  ...
  logHardwareMaintenance(dto: CreateHardwareMaintenanceDto) {
    ...
    return { message: 'Hardware maintenance logged successfully', data: record };
  }
  ...
  updateFaultStatus(id: number, dto: UpdateFaultStatusDto) {
    ...
    return { message: 'Fault status updated successfully', data: faultReports[index] };
  }
}
